...
export declare enum ZegoUIKitInvitationState {
    Error = 0,// 错误状态
    Waiting = 1,// 等待状态
    Accept = 2,// 接受状态
    Refuse = 3,// 拒绝状态
 ...
 * 拒绝呼叫邀请原因
 */
export declare enum CallInvitationRejectReason {
    Declined = "declined",
    Busy = "busy"
}
/**
 ...
 * @param data - 额外的数据对象。
 */
export type ZegoUIKitSignalingCallback = (errorCode: number, message: string, data?: any) => void;
/**
 * 呼叫中邀请配置
 */
