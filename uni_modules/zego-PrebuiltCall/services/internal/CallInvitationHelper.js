...
export default class CallInvitationHelper {
    ...
    //   });
    // }
    onInvitationSent(invitationID, allInvitees, successfulInvitees, roomID, isVideoCall, callName, showWaitingPageWhenGroupCall) {
    ...
    onInvitationAccept(invitationID, allInvitees, roomID, isVideoCall, isRedirect = false) {
    ...
    onInvitationReceived(invitationID, inviter, roomID, isVideoCall) {
